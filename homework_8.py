...
def create_tabless():
    engine.execute("""CREATE TABLE IF NOT EXISTS books (
    ...
    engine.execute("""CREATE TABLE IF NOT EXISTS books_archive (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT,
    author TEXT,
    publication_year INTEGER,
...
if __name__ == '__main__':
    engine = sqlite3.connect("books.db")
    # create_tabless()
    # insert_books(books_list)
    print(get_books_by_author("Garry Potter"))
