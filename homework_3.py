...
class Person:
    def __init__(self, name: str, birth_date: int, occupation: str = "uneployed", higher_education: bool = False):
        self.name = name
    ...
    fr1 = Friend("Азат", 2009, 'студент', True, "спорт")
    cl1 = Classmate("Анжела", 1990, "библиотекарь", True, "A113")
